"""Gazebo Harmonic + Nav2 for the Kern Phase 6 demonstration.

Starts, in one command:

  * Gazebo Harmonic with worlds/kern_corridor.sdf and the kern_bot model
  * ros_gz_bridge for /clock, /cmd_vel, /odom, /scan, /tf, /joint_states
...
can be seen arriving and lapsing independently of the robot:
...
def generate_launch_description():
    ...
    WORLD_NAME = "kern_corridor"

    package = get_package_share_directory("kern_nav2_demo")
    world = os.path.join(package, "worlds", "kern_corridor.sdf")
